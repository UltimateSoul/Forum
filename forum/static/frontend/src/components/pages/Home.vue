  ...
  <div>
      <div class="center-card">
        <b-card no-body class="overflow-hidden special-card" style="max-width: 540px;">
          <b-row no-gutters>
            <b-col md="6">
              <b-card-img :src="user.avatar ? user.avatar : 'http://e7f88eea.ngrok.io/static/images/default.jpg'" alt="Image" class="rounded-0"></b-card-img>
            </b-col>
            <b-col md="6">
      ...
      <div v-if="popularTopics.length">
        ...
        <b-table @row-clicked="clickTopic"
          ...
          <template v-slot:cell(avatar)="data">
            <img :src="data.item.author.avatar ? data.item.author.avatar : 'http://e7f88eea.ngrok.io/static/images/default.jpg'" height="100" width="100">
          </template>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getPopularTopics() {
        this.loading = true
        axios.get('http://e7f88eea.ngrok.io/core/get-popular-topics/').then(
          (response) => {
