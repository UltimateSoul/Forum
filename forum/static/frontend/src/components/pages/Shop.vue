<template>
  <div>
    ...
    <div style="background: url('http://e7f88eea.ngrok.io/static/images/golden_coins.jpg'); height: 556px">
      <b-row>
        <b-col>
          <h3>500 Coins</h3>
  ...
  export default {
    ...
    methods: {
      createPaymentIntent(coinsAmount) {
        ...
        axios.post('http://e7f88eea.ngrok.io/shop/create-payment-intent/', data).then(
          (response) => {
